...
const CommentList = () => {
  return (
    <div>
      {data.map((data, i) => (
        <Link to={`/post/${data.id}`} key={i} className='comment-list'>
          <div className='comment-list__profil'>
            <div className='comment-list__profil-img'>
              <img src={data.profil} alt='' />
            </div>
          </div>
          <div className='comment-list__post'>
            <div className='comment-list__post-header'>
              <div className='comment-list__post-header__tle'>
                <div className='comment-list__post-header__title'>
                  <h5>{data.name}</h5>
            ...
            {data.image && (
              <div className='comment-list__post-img'>
                <img src={data.image} alt='' />
              </div>
            )}

            <div className='comment-list__post-interaction'>
              <div
                title='Repondre'
                className='comment-list__post-interaction__comments'
              >
                <span>
                  <svg
              ...
              <div
                title='Repost'
                className='comment-list__post-interaction__report'
              >
                <span>
                  <svg
                    style={{ height: '20px', width: '20px' }}
              ...
              <div
                title='Aimer'
                className='comment-list__post-interaction__like'
              >
                <span>
                  <svg
                    style={{ height: '20px', width: '20px' }}
              ...
              <div
                title='Voir'
                className='comment-list__post-interaction__voir'
              >
                <span>
                  <svg
                    style={{ height: '20px', width: '20px' }}
              ...
              <div className='comment-list__post-interaction__other'>
