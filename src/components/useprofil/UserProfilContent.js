...
const UserProfilContent = () => {
  ...
  return (
    <div className='profil-content'>
      <div className='profil-content__header'>
        <div className='profil-content__header-img'>
          <img src={user.image} alt='' />
        </div>
        <div className='profil-content__header-profil'>
          <div className='profil-content__header-profil__img'>
            <img src={user.profil} alt='' />
          </div>
          <div className='profil-content__header-profil__icon'>
            <svg
      ...
      <div className='profil-content__textbox'>
        <div className='profil-content__textbox-name'>
          <h4>Karma Shopping</h4>
          <span>@luca_varan</span>
        </div>
        <div className='profil-content__textbox-intro'>
          <span>Personne Public / Créateur de contenus digitaux </span>
        </div>
        <div className='profil-content__textbox-other'>
          <div className='profil-content__textbox-other__city'>
            <svg
          ...
          <div className='profil-content__textbox-register'>
            <svg
              style={{ height: '18px', width: '18px' }}
              aria-hidden='true'
              class='r-4qtqp9 r-yyyyoo r-1xvli5t r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-14j79pv r-1d4mawv'
        ...
        <div className='profil-content__textbox-following'>
          <p>
        ...
        <span className='profil-content__textbox-message'>
